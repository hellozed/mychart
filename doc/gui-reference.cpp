...
This is NOT .cpp or python code. This code is "Processing" code. The original name is GUI.PED, and we changed it to .cpp for editing it in VSCode.
  ...
  case CESState_PktLen_Found:
    ...
    } else  //All  and data received
    {
      ...
      {     
        ...
        int RespirationRate = (int) (CES_Pkt_Data_Counter[14]);
         int global_spo2= (int) (CES_Pkt_Data_Counter[15]);
         int HeartRate = (int) (CES_Pkt_Data_Counter[16]);
        ...
        else 
        {
          ...
          lblRR.setText("Respiration: " + RespirationRate+ " rpm");
          lblHR.setText("Heart Rate: " + HeartRate + " bpm");          
        }
