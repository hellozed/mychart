...
# This is code for using a Raspberry Pi to simulate bluetooth sensor device.
# ----------------------------------------------------------------------------

'''
BlueZ (http://www.bluez.org/) is a module for developing BLE software on Linux, the latest version 
is v5.5.4 and Raspberry Pi has bluez 5.50 by default.
